...
public class MyHelper extends SQLiteOpenHelper{
    ...
    sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS ACCOUNT( ID INTEGER PRIMARY KEY AUTOINCREMENT, INOUT VARCHAR(255), DESCRIPTION VARCHAR(255) UNIQUE, AMOUNT MONEY);");
    }
